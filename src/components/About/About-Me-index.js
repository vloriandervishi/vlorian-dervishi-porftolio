    ...
    return (
        <section>
            ...
            <div> <img src={picture}></img>
                ...
                obtained associate of science degree from nashville state community college with the concentration in computer science and Full-Stack-Developer certification from vanderbilt university boot camp.</p>
            </div>
        </section>
    );
}
